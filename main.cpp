...
int main() {
    try {
        ...
        pc->onGatheringStateChange([pc](rtc::PeerConnection::GatheringState state) {
            ...
            // send sdp message when gathering is complete, only for copy-paste sdp exchange
        ...
        auto dataChannel = pc->createDataChannel("numberChannel");

        dataChannel->onOpen([]() { std::cout << "Data channel opened" << std::endl; });
